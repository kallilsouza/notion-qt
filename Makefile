...
DISTDIR = /home/kallil/projetos/projetos\ pessoais/qt-apps/notion-qt/.tmp/project1.0.0
LINK          = g++
...
distdir: FORCE
	...
	$(COPY_FILE) --parents notion.cpp $(DISTDIR)/
...
notion.o: notion.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o notion.o notion.cpp
